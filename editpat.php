	...
	<div id = "content">
       ...
       <div class="form-group">&nbsp;&nbsp;&nbsp;
        ...
        <div class="form-group">&nbsp;&nbsp;&nbsp;
         ...
         <div class="form-group">&nbsp;&nbsp;&nbsp;
            <span style="color:red;">*</span><b>Address</b><br>&nbsp;&nbsp;&nbsp;
            <input type ="text" name="address" value="<?php echo  $address;?>" class="form-control" pattern="[A-Za-z]{1,20}" title="Enter characters only">
        </div> 
        
						
				<button class = "btn btn-warning" name = "edit_pat" ><span class = "glyphicon glyphicon-edit"></span> SAVE</button>
				<br />
					</div>	
