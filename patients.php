			...
			<div class = "panel-body">
              ...
              <input type="date" class="form-control" name="dob"  required="required" >
               ...
               <div class="form-group">
	                ...
	                <input type="text" name="address" class="form-control" placeholder="Enter Address" required="required" title="Enter characters only">
		       </div>              
              					
				<button type="submit" class = "btn btn-primary" name = "save_pat" ><span class = "glyphicon glyphicon-save"></span> SAVE</button>
				<br />
			</div>	
		...
		<div class = "panel panel-primary">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					<tbody>
					<?php
						$query = $conn->query("SELECT id,concat(firstname,' ',middlename,' ',lastname) as name,gender,phone,idno FROM patients order by id") or die(mysqli_error());
					...
					?>
						<tr>
							...
							<td><center><a href="bappoint.php?id=<?php echo $fetch['id']; ?>"><span class="btn btn-primary bg-green"><i class="fa fa-edit"></i> Book Appointment </span></a>
								<a href="editpat.php?id=<?php echo $fetch['id']; ?>"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Edit </span></a>
